    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        try {
            ...
            if (username != null && authentication == null) {
                var userDetail = _managerService.userDetailsService().loadUserByUsername(username);

                if (_jwtService.isTokenValid(jwt, userDetail)) {
            ...
            _handlerExceptionResolver.resolveException(request, response, null, ex);
        }
    }
