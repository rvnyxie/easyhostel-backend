...
/**
 * Interface for RoomAmenity service, extends base GET methods
 *
 * @author Nyx
 */
public interface IRoomAmenityReadonlyService extends IBaseReadonlyService<RoomAmenityDto, String> {
}
